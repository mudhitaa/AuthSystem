...
export const flows: Flow[] = [
  {
    ...
    steps: [
      ...
      { actor: 'email', text: 'Send verification email', detail: 'Nodemailer sends HTML email via Gmail SMTP with verify link' },
  ...
  },
  {
    ...
    steps: [
      ...
      { actor: 'email', text: 'Send reset email', detail: 'HTML email with reset link containing plain token' },
